  ...
  const integrations = [
    {
      ...
      color: '#F59E0B',
      preview: (
        <div className="rounded overflow-hidden border border-[#2F4257] bg-[#0F1828] p-3">
          <div className="flex items-end gap-0.5 h-16 mb-2">
            {[40, 60, 80, 70, 90, 50, 30, 20].map((h, i) => (
              <div
                key={i}
                className="flex-1 rounded-t"
                style={{ background: '#F59E0B', height: `${h}%`, opacity: 0.8 }}
              />
            ))}
          </div>
          <p style={{ fontSize: '9px', color: '#98A3B1', textAlign: 'center' }}>
            Dashboard sync
          </p>
        </div>
      ),
        ...
        <div className="rounded overflow-hidden border border-[#2F4257] bg-[#0F1828] p-3">
          <div className="space-y-2 mb-2">
            <div className="flex items-center gap-2">
              ...
              <div className="h-1 flex-1 bg-[#2F4257] rounded" />
            </div>
            <div className="flex items-center gap-2">
              <div className="w-1 h-1 rounded-full bg-[#10B981]" />
              <div className="h-1 flex-1 bg-[#2F4257] rounded" style={{ width: '80%' }} />
            </div>
            <div className="flex items-center gap-2">
              <div className="w-1 h-1 rounded-full bg-[#10B981]" />
              <div className="h-1 flex-1 bg-[#2F4257] rounded" style={{ width: '60%' }} />
            </div>
          </div>
          <p style={{ fontSize: '9px', color: '#98A3B1', textAlign: 'center' }}>
            Commit tracking
        ...
        <div className="rounded overflow-hidden border border-[#2F4257] bg-[#0F1828] p-3">
          <div className="space-y-1.5 mb-2">
            <div className="flex gap-1">
              <div className="w-4 h-4 rounded bg-[#6266FA]" />
              <div className="flex-1 space-y-1">
                <div className="h-1 bg-[#2F4257] rounded" style={{ width: '80%' }} />
                <div className="h-1 bg-[#2F4257] rounded" style={{ width: '60%' }} />
              </div>
            </div>
          </div>
          <p style={{ fontSize: '9px', color: '#98A3B1', textAlign: 'center' }}>
