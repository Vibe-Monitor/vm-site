...
import { Zap, CheckCircle2, FileCode, Send, Sparkles, ArrowRight, Search, GitBranch, AlertTriangle, MessageSquare } from 'lucide-react';
  ...
  return (
    <section className="relative py-32 px-8 overflow-hidden">
      ...
      <div className="max-w-5xl mx-auto relative z-10">
        ...
        {/* Enhanced Bottom Stats with glassmorphism */}
        <AnimatePresence>
          {stage === 'thread-complete' && (
            <motion.div
              initial={{ opacity: 0, y: 20 }}
            ...
            >
              ...
              >
                ...
                <p style={{ fontSize: '14px', color: '#95A3B2', fontWeight: 500 }}>Total time</p>
              </motion.div>
              ...
              >
                ...
                <p style={{ fontSize: '14px', color: '#95A3B2', fontWeight: 500 }}>Automated</p>
              </motion.div>
              ...
              >
                ...
                <p style={{ fontSize: '14px', color: '#95A3B2', fontWeight: 500 }}>Confidence</p>
              </motion.div>
            </motion.div>
          )}
        </AnimatePresence>
